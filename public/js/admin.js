...
async function initDashboard() {
  ...
  await loadRatings();
  await loadErrors();
  if (typeof loadContentStats === 'function') await loadContentStats();
  if (typeof loadEngagement === 'function') await loadEngagement();
  await loadMembers();
  await loadRevenue();
...
async function loadErrors() {
  ...
  try {
    ...
    // Breakdown strip (pages + devices worst hit) lives in admin-dashboard-extra.js.
...
// NOTE: statTile / loadContentStats / loadEngagement live in
// public/js/admin-dashboard-extra.js (loaded before admin.js on admin-panel.html)
