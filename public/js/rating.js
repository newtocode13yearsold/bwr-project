...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '.footer-rating__score{display:inline-flex;align-items:center;gap:6px;font-weight:700;color:var(--text-strong,#0b2410)}'
      ...
      + '.footer-rating__stars i{font-style:normal;color:rgba(120,120,120,.35)}'
      + '.footer-rating__stars b{position:absolute;left:0;top:0;overflow:hidden;white-space:nowrap;color:#f59e0b;font-weight:400}'
      + '.footer-rating__count{color:var(--text-muted,#6b7280);font-weight:500;font-size:.9rem}'
      + '.footer-rating__btn{border:1px solid var(--border-strong,#c8d0bf);background:transparent;color:var(--text,#1f2937);'
      ...
      + '.footer-rating__btn:hover{background:var(--surface-2,#f3f4f0);border-color:var(--forest-500,#4a8a32)}'
