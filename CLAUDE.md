...
| `tests/worker-errors.test.mjs` | Error monitoring — public ingest, signature grouping + count, bot/empty drop, throttled ntfy alert, admin-only list/delete/clear | ESM |
