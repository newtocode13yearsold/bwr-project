...
- Name: map.spec.js >> Signalement de problème >> le bouton Signaler est présent
- Location: tests\e2e\map.spec.js:96:7
...
Locator: locator('button:has-text("Signaler"), #reportBtn, [id*="report"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Signaler"), #reportBtn, [id*="report"]').first()
